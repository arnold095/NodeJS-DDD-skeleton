...
export class UserRegisteredDomainEvent extends DomainEvent {
    ...
    public constructor(readonly id: string, readonly firstName: string,
                       readonly lastName: string, readonly email: string,
                       readonly password: string, readonly dateAdd: Date,
    ...
    public static fromPrimitives(aggregateId: string, body:UserRegisteredEventBody,
                                 eventId: string, occurredOn: Date):UserRegisteredDomainEvent {
        return new UserRegisteredDomainEvent(
            aggregateId,
            body.firstName, body.lastName,
            body.email, body.password,
            body.dateAdd, body.dateUpd,
            eventId,
            occurredOn,
        );
    }
